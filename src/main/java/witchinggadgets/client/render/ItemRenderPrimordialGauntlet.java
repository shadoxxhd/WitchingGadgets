    ...
    public void renderItem(ItemRenderType type, ItemStack stack, Object... data) {
        ...
        try {
            ...
            switch (type) {
                ...
                case EQUIPPED:
                    ...
                    ClientUtilities.bindTexture(
                            equippingPlayer.getLocationSkin().getResourceDomain() + ":"
            ...
            for (int f = 0; f < 5; f++) {
                ...
                GL11.glColor3d(
                        fingerOverlayColour[colour][0] / 255.0,
                        fingerOverlayColour[colour][1] / 255.0,
                        fingerOverlayColour[colour][2] / 255.0);
            ...
            if (runeColour > 15) runeColour = 16 - (runeColour - 16);
            GL11.glScalef(overlayScale, overlayScale, overlayScale);
            ...
            if (type == ItemRenderType.EQUIPPED_FIRST_PERSON) {
                ...
                if (sel >= 0 && sel < gems.length && gems[sel] != null) {
                    ...
                    GL11.glTranslated(
                            ...
                            0,
                            sel == 0 || sel == 2 ? .05625 : sel == 1 || sel == 4 ? .14 : .1);
                ...
                double entRot = ((entItem.age + UtilsFX.getTimer(mc).renderPartialTicks) / 20.0F + entItem.hoverStart)
                        * (180F / (float) Math.PI);
