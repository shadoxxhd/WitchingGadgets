...
public class TileRenderIceGen extends TileEntitySpecialRenderer {
    public void renderTileEntityAt(TileEntityIceGen tile, double x, double y, double z, float f) {
        GL11.glPushMatrix();
        ...
        else ClientUtilities.bindTexture("thaumcraft:textures/blocks/lifterside.png");
        ...
        if (tile.getWorldObj() == null
                || tile.getWorldObj().getBlockPowerInput(tile.xCoord, tile.yCoord, tile.zCoord) <= 0
                        && !tile.getWorldObj().isBlockIndirectlyGettingPowered(tile.xCoord, tile.yCoord, tile.zCoord)) {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double d0, double d1, double d2, float f) {
        renderTileEntityAt((TileEntityIceGen) tileentity, d0, d1, d2, f);
    }
}
