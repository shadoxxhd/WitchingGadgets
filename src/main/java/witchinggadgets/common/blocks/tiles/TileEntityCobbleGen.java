...
public class TileEntityCobbleGen extends TileEntityWGBase {
    ...
    public void updateEntity() {
        ...
        if (canWork()) {
            ...
            if (tick >= tickGoal) {
                if (!worldObj.isRemote) createCobble();
    ...
    private void createCobble() {
        ...
        if (inventory instanceof IInventory) cobble = InventoryUtils
                .placeItemStackIntoInventory(cobble, (IInventory) inventory, this.facing.getOpposite().ordinal(), true);
