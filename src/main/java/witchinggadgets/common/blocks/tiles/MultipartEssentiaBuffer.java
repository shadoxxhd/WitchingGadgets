...
public class MultipartEssentiaBuffer extends McMetaPart implements IAspectContainer, IEssentiaTransport, IWandable {
                        ...
                        if (ibox.data instanceof ForgeDirection) {
                            ...
                            if (player.isSneaking()) {
                                player.worldObj.playSound(
                                        ...
                                        "thaumcraft:tool",
                                        .6f,
                                        1.1f + player.worldObj.rand.nextFloat() * .2f,
                                        false);
                                this.chokedSides[fd.ordinal()] += 1;
                                if (this.chokedSides[fd.ordinal()] > 2) this.chokedSides[fd.ordinal()] = 0;
    ...
    public Aspect getEssentiaType(ForgeDirection fd) {
        return this.aspects.size() > 0
                ? this.aspects.getAspects()[world().rand.nextInt(this.aspects.getAspects().length)]
                : null;
    }
