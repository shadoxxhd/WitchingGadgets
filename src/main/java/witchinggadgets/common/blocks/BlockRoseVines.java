...
public class BlockRoseVines extends Block implements IWandable, IShearable {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z) {
        ...
        if (world.isSideSolid(x, y - 1, z, ForgeDirection.UP, false)) maxY = 0.375F;
        ...
        if (world.isSideSolid(x, y, z + 1, ForgeDirection.NORTH, false)) maxZ = 1.0F;
        if (world.isSideSolid(x + 1, y, z, ForgeDirection.EAST, false)) maxX = 1.0F;
