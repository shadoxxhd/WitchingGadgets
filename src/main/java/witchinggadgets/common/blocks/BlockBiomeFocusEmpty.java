...
public class BlockBiomeFocusEmpty extends BlockContainer implements ITerraformFocus {
	...
	public void onBlockAdded(World p_149726_1_, int p_149726_2_, int p_149726_3_, int p_149726_4_){
		if (this.Saved==null)
		this.Saved = p_149726_1_.getBiomeGenForCoords(p_149726_2_, p_149726_4_);
	...
	public Aspect requiredAspect(int metadata) {
		if (Saved!=null) {
		if (Saved.getTempCategory() == BiomeGenBase.TempCategory.COLD)
			return Aspect.COLD;
		if (Saved.getTempCategory() == BiomeGenBase.TempCategory.WARM)
			return Aspect.FIRE;
		if (Saved.getTempCategory() == BiomeGenBase.TempCategory.OCEAN)
			return Aspect.WATER;
		if (Saved.getTempCategory() == BiomeGenBase.TempCategory.MEDIUM)
			return Aspect.EARTH;
		}
		return null;
	}
