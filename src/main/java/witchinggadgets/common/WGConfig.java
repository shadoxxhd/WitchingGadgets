...
public class WGConfig {
    ...
    public static final String[] DEFAULTCLUSTERS = { "Infinity", "Infinity Catalyst", "Neutronium", "Indium", "Iridium",
    ...
    public static void loadConfig(FMLPreInitializationEvent event) {
        ...
        allowClusters = config.get(
                ...
                "Enable clusters",
                true,
                "Set this to false to disable clusters, useful when you are using AOBD.").getBoolean(true);
        allowTransmutations = config
                .get(
                        "Ore/Crucible",
        ...
        tripplingClusterList = config.get(
                ...
                DEFAULTCLUSTERS,
                "A list of ore names for which no native Cluster will get generated").getStringList();
        ...
        limitBookSearchToCategory = config.get(
                ...
                false,
                "Thaumonomicon Search to currently active category").getBoolean(false);

        enableSearch = config
                .get("Search", "Enables the search function in the Thaumonomicon", true, "Thaumonomicon Search enabled")
                .getBoolean(true);
        ...
        coremod_allowBootsRepair = config.get(
                ...
                true,
                "Dis-/enable repairing the Boots of the Traveller with leather").getBoolean(true);
        ...
        modulePrimal = config.get(
                ...
                true,
                "Dis-/enable the primordial gauntlet, armor and weapons").getBoolean(true);
        moduleBag = config.get("Modules", "Enable Bags", true, "Enable Bags").getBoolean(true);
        bagVoid = config
                .get("Modules", "Enable Voidlinked Bag", true, "Enable Voidlinked Bag. Requires Bags to be enabled")
                .getBoolean(true);
        bagEnder = config
                .get("Modules", "Enable Enderlinked Bag", true, "Enable Enderlinked Bag. Requires Bags to be enabled")
                .getBoolean(true);
        bagHungry = config.get("Modules", "Enable Hungry Bag", true, "Enable Hungry Bag. Requires Bags to be enabled")
                .getBoolean(true);
        moduleCloak = config.get("Modules", "Enable Cloaks", true, "Enable Cloaks").getBoolean(true);
        moduleKama = config
                .get(
                        "Modules",
                ...
                .getBoolean(true);
        capeSpectral = config
                .get("Modules", "Enable Spectral Mantle", true, "Enable Spectral Mantle. Requires Cloaks to be enabled")
                .getBoolean(true);
        capeStorage = config
                .get("Modules", "Enable Cloak of Voluminous Pockets", true, "Enable Cloak of Voluminous Pockets")
                .getBoolean(true);
        capeWolf = config
                .get("Modules", "Enable Wolven Cloak", true, "Enable Wolven Cloak. Requires Cloaks to be enabled")
                .getBoolean(true);
        capeRaven = config
                .get(
                        "Modules",
        ...
        moduleGemcutting = config
                .get("Modules", "Enable Gemcutting", true, "Dis-/enable the gem table, and other crystal things")
                .getBoolean(true);
