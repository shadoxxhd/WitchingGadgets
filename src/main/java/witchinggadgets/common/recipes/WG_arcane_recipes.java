...
public class WG_arcane_recipes {
	...
	if (WGConfig.moduleCloak) {
		...
		registerArcaneRecipe("CLOAK","",standardCloak, craftingAspects, "RSR","GFG","GFG", 'F', new ItemStack(ConfigItems.itemResource, 1, 7),'G',new ItemStack(WGContent.ItemMaterial,1,5),'R',"ringThaumium",'S',new ItemStack(WGContent.ItemMaterial,1,3));
