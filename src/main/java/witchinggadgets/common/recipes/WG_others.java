		...
		if(name.startsWith("cluster")) {
			...
			if (!OreDictionary.getOres(name).isEmpty()&&!OreDictionary.getOres("gem"+aMaterial).isEmpty()) {
				...
				case "CertusQuartz": case "NetherQuartz":{
					GT_Values.RA.addSifterRecipe(OreDictionary.getOres(name).get(0).copy(), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L), GT_OreDictUnificator.get(OrePrefixes.gemFlawless, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  GT_OreDictUnificator.get(OrePrefixes.gemFlawed, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L), GT_OreDictUnificator.get(OrePrefixes.gemChipped, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get(aMaterial),  2L)}, chanche, 3200, 30);
					break;
				}
				case "Apatite": {
					GT_Values.RA.addSifterRecipe(OreDictionary.getOres(name).get(0).copy(), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  4L),  4L), GT_OreDictUnificator.get(OrePrefixes.gemFlawless, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  4L),  4L),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  4L),  GT_OreDictUnificator.get(OrePrefixes.gemFlawed, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  4L),  4L), GT_OreDictUnificator.get(OrePrefixes.gemChipped, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  4L),  4L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get(aMaterial),  4L)}, chanche, 6400, 30);
					break;
				}
				case "Amber":{
					GT_Values.RA.addSifterRecipe(OreDictionary.getOres(name).get(0).copy(), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L), GT_OreDictUnificator.get(OrePrefixes.gemFlawless, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  GT_OreDictUnificator.get(OrePrefixes.gemFlawed, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L), GT_OreDictUnificator.get(OrePrefixes.gemChipped, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  2L),  2L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get(aMaterial),  2L)}, new int[]{600, 2400, 9000, 2400, 5600, 7000}, 3200, 30);
					break;
				}
				case "Lapis": case "Sodalite": case "Lazurite":{
					GT_Values.RA.addSifterRecipe(OreDictionary.getOres(name).get(0).copy(), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  6L),  6L), GT_OreDictUnificator.get(OrePrefixes.gemFlawless, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  6L),  6L),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  6L),  GT_OreDictUnificator.get(OrePrefixes.gemFlawed, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  6L),  6L), GT_OreDictUnificator.get(OrePrefixes.gemChipped, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  6L),  6L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get(aMaterial),  6L)}, chanche, 9600, 30);
					break;
				}
				case "Monazite":{
				...
				default:{
					GT_Values.RA.addSifterRecipe(OreDictionary.getOres(name).get(0).copy(), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  1L),  1L), GT_OreDictUnificator.get(OrePrefixes.gemFlawless, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  1L),  1L),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  1L),  GT_OreDictUnificator.get(OrePrefixes.gemFlawed, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  1L),  1L), GT_OreDictUnificator.get(OrePrefixes.gemChipped, Materials.get(aMaterial),GT_OreDictUnificator.get(OrePrefixes.gem, Materials.get(aMaterial),  1L),  1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.get(aMaterial),  1L)}, chanche, 1600, 30);
					break;
				}
				}
			}
