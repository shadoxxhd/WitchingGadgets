...
public class WG_Infusion {
    ...
    public static void register_infusion() {
        ...
        registerInfusionRecipe(
                ...
                new ItemStack[] {
                    ...
                    ItemList.IC2_EnergyCrystal.getWildcard(1L),
                    new ItemStack(ConfigBlocks.blockCrystal, 1, 3),
        ...
        if (WGConfig.moduleBag) {
            if (WGConfig.bagEnder) {
                infusionAspects = new AspectList()
                        .add(Aspect.VOID, 64)
            ...
            if (WGConfig.bagVoid) {
                ...
                registerInfusionRecipe(
                        ...
                        new ItemStack(WGContent.ItemBag, 1, 0),
                        new ItemStack[] {
                            GT_ModHandler.getModItem("Railcraft", "machine.beta", 1L, 11),
                            new ItemStack(WGContent.ItemMaterial, 1, 3),
        ...
        registerInfusionRecipe(
                ...
                new ItemStack[] {
                    Materials.Platinum.getIngots(1),
        ...
        if (WGConfig.terraformer) {
            if (Loader.isModLoaded("dreamcraft")) {
                infusionAspects = new AspectList()
                        .add(Aspect.WEATHER, 64)
                        .add(Aspect.EXCHANGE, 256)
            ...
            registerInfusionRecipe(
                    ...
                    new ItemStack[] {
                        gregtech.api.util.GT_ModHandler.getModItem("thaumicbases", "blockSalisMundus", 1),
        ...
        if (WGConfig.modulePrimal) {
            ...
            infusionAspects = new AspectList()
                    .add(Aspect.MAGIC, 512)
                    .add(Aspect.METAL, 1024)
                    .add(Aspect.WEAPON, 512)
                    .add(Aspect.AIR, 256)
                    .add(Aspect.FIRE, 256)
            ...
            registerInfusionRecipe(
                    ...
                    new ItemStack[] {
                        new ItemStack(ConfigItems.itemWispEssence),
                        new ItemStack(ConfigItems.itemPickVoid),
                        new ItemStack(ConfigItems.itemWispEssence),
                        new ItemStack(ConfigItems.itemEldritchObject, 1, 3),
                        new ItemStack(ConfigItems.itemWispEssence),
                        new ItemStack(ConfigItems.itemResource, 1, 15),
            ...
            registerInfusionRecipe(
                    ...
                    new ItemStack[] {
                        new ItemStack(ConfigItems.itemWispEssence),
                        new ItemStack(ConfigItems.itemAxeVoid),
                        new ItemStack(ConfigItems.itemWispEssence),
                        new ItemStack(ConfigItems.itemEldritchObject, 1, 3),
                        new ItemStack(ConfigItems.itemWispEssence),
                        new ItemStack(ConfigItems.itemResource, 1, 15),
            ...
            infusionAspects = new AspectList()
                    .add(Aspect.SENSES, 256)
                    .add(Aspect.AURA, 128)
                    .add(Aspect.ARMOR, 128);
            registerInfusionRecipe(
                    "HELMGOGGLES",
                    "_PRIMORDIAL",
        ...
        if (WGConfig.moduleGemcutting)
            registerInfusionEnchantmentRecipe(
                    "ENCH_INVISIBLEGEAR", "", WGContent.enc_invisibleGear, 2, infusionAspects, new ItemStack[] {
        ...
        infusionAspects = new AspectList()
                .add(Aspect.LIGHT, 64)
                .add(Aspect.SENSES, 48)
                .add(Aspect.MAGIC, 48)
                .add(Aspect.CRYSTAL, 32);
        registerInfusionEnchantmentRecipe(
                "ENCH_UNVEILING", "", WGContent.enc_unveiling, 2, infusionAspects, new ItemStack[] {
        ...
        infusionAspects = new AspectList()
                .add(Aspect.MOTION, 64)
                .add(Aspect.DARKNESS, 48)
                .add(Aspect.MAGIC, 48)
                .add(Aspect.GREED, 32);
        registerInfusionEnchantmentRecipe(
                "ENCH_STEALTH", "", WGContent.enc_stealth, 2, infusionAspects, new ItemStack[] {
        ...
        infusionAspects = new AspectList()
                .add(Aspect.WEAPON, 48)
                .add(DarkAspects.ENVY, 32)
                .add(Aspect.MAGIC, 16);
        registerInfusionEnchantmentRecipe(
                "ENCH_BACKSTAB", "", WGContent.enc_backstab, 3, infusionAspects, new ItemStack[] {
        ...
        registerInfusionEnchantmentRecipe(
                "ENCH_RIDEPROTECT", "", WGContent.enc_rideProtect, 3, infusionAspects, new ItemStack[] {
                    new ItemStack(ConfigItems.itemResource, 1, 14),
        ...
        infusionAspects = new AspectList()
                ...
                .add(Aspect.ELDRITCH, 32);
        registerInfusionEnchantmentRecipe(
                "ENCH_SOULBOUND", "", WGContent.enc_soulbound, 1, infusionAspects, new ItemStack[] {
                    new ItemStack(Items.ender_eye), new ItemStack(Items.ender_pearl), new ItemStack(Items.name_tag)
                });
        WGModCompat.thaumicTinkererRegisterEnchantment(
    ...
    private static void registerInfusionRecipe(
            String tag,
            String tagAddon,
            Object result,
            int difficulty,
            AspectList infusionAspects,
            ItemStack centralIngredient,
            ItemStack[] otherIngredients) {
        InfusionRecipe infusionRecipe = ThaumcraftApi.addInfusionCraftingRecipe(
                tag, result, difficulty, infusionAspects, centralIngredient, otherIngredients);
        WGContent.recipeList.put(tag + tagAddon, infusionRecipe);
    }

    private static void registerInfusionEnchantmentRecipe(
            String tag,
            String tagAddon,
            ...
            AspectList infusionAspects,
            ItemStack[] otherIngredients) {
        InfusionEnchantmentRecipe infusionRecipe = ThaumcraftApi.addInfusionEnchantmentRecipe(
                tag, enchantment, difficulty, infusionAspects, otherIngredients);
        WGContent.recipeList.put(tag + tagAddon, infusionRecipe);
    }
}
