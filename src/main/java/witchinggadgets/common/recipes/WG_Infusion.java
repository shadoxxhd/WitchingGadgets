...
public class WG_Infusion {
    ...
    public static void register_infusion() {
        ...
        registerInfusionRecipe(
                ...
                ItemList.Machine_HV_FluidSolidifier.get(1L),
                new ItemStack[] { ItemList.Conveyor_Module_HV.get(1L), new ItemStack(ConfigBlocks.blockCrystal, 1, 2),
                        new ItemStack(Blocks.ice), new ItemStack(ConfigBlocks.blockCrystal, 1, 4),
                        ItemList.IC2_EnergyCrystal.getWildcard(1L), new ItemStack(ConfigBlocks.blockCrystal, 1, 4),
                        new ItemStack(Blocks.packed_ice), new ItemStack(ConfigBlocks.blockCrystal, 1, 2) });

        if (WGConfig.moduleBag) {
            if (WGConfig.bagEnder) {
                infusionAspects = new AspectList().add(Aspect.VOID, 64).add(Aspect.ELDRITCH, 64).add(Aspect.MAGIC, 128)
            ...
            if (WGConfig.bagVoid) {
                infusionAspects = new AspectList().add(Aspect.VOID, 256).add(Aspect.ELDRITCH, 32)
            ...
            if (WGConfig.capeSpectral) {
                infusionAspects = new AspectList().add(Aspect.SOUL, 48).add(Aspect.TRAVEL, 48).add(Aspect.ELDRITCH, 24)
        ...
        if (Config.allowMirrors) {
            // WALLMIRROR
            infusionAspects = new AspectList().add(Aspect.VOID, 20).add(Aspect.TRAVEL, 20).add(Aspect.ELDRITCH, 20)
        ...
        infusionAspects = new AspectList().add(Aspect.MINE, 48).add(Aspect.TOOL, 24).add(Aspect.MOTION, 24)
        ...
        infusionAspects = new AspectList().add(Aspect.AIR, 32).add(Aspect.WEAPON, 16).add(Aspect.ORDER, 8)
                .add((Aspect) gregtech.api.enums.TC_Aspects.NEBRISUM.mAspect, 8);
        registerInfusionRecipe(
                "WGBAUBLES",
                "_SNIPERRING",
        ...
        if (WGConfig.terraformer) {
            if (Loader.isModLoaded("dreamcraft")) {
                infusionAspects = new AspectList().add(Aspect.WEATHER, 64).add(Aspect.EXCHANGE, 256)
        ...
        infusionAspects = new AspectList().add(Aspect.SENSES, 24).add(Aspect.WEATHER, 8).add(Aspect.WATER, 64)
                .add(Aspect.HEAL, 16);
        registerInfusionRecipe(
                "SAUNASTOVE",
                "",
        ...
        if (WGConfig.modulePrimal) {
            ...
            infusionAspects = new AspectList().add(Aspect.AIR, 64).add(Aspect.FIRE, 64).add(Aspect.EARTH, 64)
            ...
            if (WGConfig.moduleGemcutting) {
                infusionAspects = new AspectList().add(Aspect.MAGIC, 512).add(Aspect.CRYSTAL, 256).add(Aspect.TOOL, 128)
            ...
            infusionAspects = new AspectList().add(Aspect.MAGIC, 512).add(Aspect.METAL, 1024).add(Aspect.WEAPON, 512)
            ...
            infusionAspects = new AspectList().add(Aspect.MAGIC, 512).add(Aspect.METAL, 1024).add(Aspect.TOOL, 256)
            ...
            //
            infusionAspects = new AspectList().add(Aspect.MAGIC, 512).add(Aspect.METAL, 1024).add(Aspect.ARMOR, 256)
                    .add(Aspect.AIR, 256).add(Aspect.FIRE, 256).add(Aspect.WATER, 256).add(Aspect.EARTH, 256)
                    .add(Aspect.ORDER, 256).add(Aspect.ENTROPY, 256);
            registerInfusionRecipe(
                    "PRIMORDIALARMOR",
         ...
         * ENCHANTMENT
         */
        infusionAspects = new AspectList().add(Aspect.DARKNESS, 48).add(Aspect.CRYSTAL, 48).add(Aspect.MAGIC, 48)
                .add(Aspect.ARMOR, 32).add(Aspect.AURA, 24).add(Aspect.SOUL, 8);
        if (WGConfig.moduleGemcutting) registerInfusionEnchantmentRecipe(
                "ENCH_INVISIBLEGEAR",
                "",
        ...
        else registerInfusionEnchantmentRecipe(
                "ENCH_INVISIBLEGEAR",
                "",
                WGContent.enc_invisibleGear,
                2,
        ...
        infusionAspects = new AspectList().add(Aspect.LIGHT, 64).add(Aspect.SENSES, 48).add(Aspect.MAGIC, 48)
        ...
        infusionAspects = new AspectList().add(Aspect.MOTION, 64).add(Aspect.DARKNESS, 48).add(Aspect.MAGIC, 48)
                .add(Aspect.GREED, 32);
        registerInfusionEnchantmentRecipe(
                "ENCH_STEALTH",
                "",
        ...
        infusionAspects = new AspectList().add(Aspect.SOUL, 64).add(Aspect.MAGIC, 48).add(Aspect.GREED, 24)
    ...
    private static void registerInfusionRecipe(String tag, String tagAddon, Object result, int difficulty,
    ...
    private static void registerInfusionEnchantmentRecipe(String tag, String tagAddon, Enchantment enchantment,
