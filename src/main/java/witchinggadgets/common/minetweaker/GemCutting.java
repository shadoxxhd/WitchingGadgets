...
public class GemCutting {
    ...
    private static class Add implements IUndoableAction {
        ...
        @Override
        public void apply() {
            if (type == 0) InfusedGemHandler.registerAffinities(key, aspects);
            else InfusedGemHandler.registerAversions(key, aspects);
        }
        ...
        @Override
        public void undo() {
            if (type == 0) InfusedGemHandler.removeAffinities(key);
            else InfusedGemHandler.removeAversions(key);
        }
